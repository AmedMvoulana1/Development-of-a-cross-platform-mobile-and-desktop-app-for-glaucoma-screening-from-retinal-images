...
def bright_points(image):
    ...
    cv2.imwrite(outpath+'2_image_seuillee.png', image_b)
...
image = cv2.imread(base+'drishtiGS_036.png')
...
cropped = image[centre_disque[1]-120:centre_disque[1]+120, centre_disque[0]-120:centre_disque[0]+120]
cv2.imwrite(outpath+'7_cropped.jpg', cropped)
