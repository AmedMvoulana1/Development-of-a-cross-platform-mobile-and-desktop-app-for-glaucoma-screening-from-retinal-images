...
class ShowcaseApp(App):
    ...
    def saveCDR(self):
    	os.chdir(liste[0])
    	screen = self.load_screen(self.screen_names.index('Détecter'))
    ...
    def build(self):
        ...
        self.available_screens = sorted([
            'Langues','Crédits', 'Aides', 'Accueil', 'Détecter', 'Commencer', 'Capturer', 'Parcourir', 'Démarrer', 'Choose', 'Create', 'Save'])
